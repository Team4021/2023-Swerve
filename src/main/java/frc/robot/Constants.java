...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kClawMotorCanID = 13;
  ...
  public static final class ModuleConstants {
    ...
    // 40 teeth on the wheel's bevel gear, 22 teeth on the first-stage spur gear, 15 teeth on the bevel pinion
    public static final double kDrivingMotorReduction = (6.67);
  ...
  public static final class OIConstants {
    ...
    public static final double kSecondaryDeadband =  0.12;
  }
